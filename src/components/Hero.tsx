  ...
  return (
    ...
    >
      ...
      {[
        ...
        <div key={i} aria-hidden="true" style={{ position: 'absolute', width: '40px', height: '40px', pointerEvents: 'none', zIndex: 5, ...s }} />
      ))}
      ...
      <div style={{
        ...
        textAlign: 'center', maxWidth: '700px', padding: '0 24px', width: '100%',
      }}>
        {/* Badge */}
        <motion.div {...fadeIn(0.2)} style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '28px' }}>
        ...
        <motion.p {...fadeIn(0.8)} style={{
          ...
          maxWidth: '480px', lineHeight: 1.65, margin: '0 0 32px',
        }}>
          Premium hookah rentals for restaurants, lounges &amp; private events across South Florida
        </motion.p>

        {/* Separator */}
        <motion.div {...fadeIn(0.9)} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '36px' }}>
